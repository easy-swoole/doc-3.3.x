...
- HTTP service
    - [Rooter](/En/HttpServer/fastRoute.md)
    - [Controller](/En/HttpServer/controller.md)
    - [Annotation controller](/En/HttpServer/annotation.md)
    ...
    - [Session](/En/HttpServer/session.md)
    - [Errors and exceptions](/En/HttpServer/exception.md)
    - [Static resources and cross domain processing](/En/HttpServer/static.md)
    - [Common problem](/En/HttpServer/problem.md)
- Socket service
    - [TCP server](/En/Socket/tcp.md)
    - [TCP server handles packet sticking](/En/Socket/tcpSticky.md)
